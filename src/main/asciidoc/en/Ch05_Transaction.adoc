...
====
In the tasklet model, transaction control is newly performed within the transaction controlled by {SB}.
Therefore, it is necessary to set Propagation of Transaciton Manager to *REQUESTS_NEW*.
====
