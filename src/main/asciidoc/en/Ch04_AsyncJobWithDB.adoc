...
[WARNING]
====
Since PostgreSQL supports auto-numbering of columns, job request sequence is not defined in DDL included in  jar of {batch5_shortname}.
====
...
Set extended interface created in (2) in ``batchJobRequestMapper`` and
