...
<<Ch04_AsyncJobWithDB.adoc,"Asynchronous execution (DB polling)">> performs asynchronous execution of multiple jobs registered in the request management table. +
...
The function is same as <<Ch04_AsyncJobWithDB.adoc,"Asynchronous execution (DB polling)">> and use
...
<<Ch03_CreateProject.adoc,"How to create a project">> and <<Ch04_AsyncJobWithDB.adoc,"Asynchronous execution (DB polling)">>.
...
This is same as the method of specifying job parameters in <<Ch04_AsyncJobWithDB.adoc,"Asynchronous execution (DB polling)">>.
====
...
for ``JobController`` of <<Ch04_AsyncJobWithWeb_Imprement_Controller, Implementation of controller>>.
...
However, as described in <<Ch04_AsyncJobWithWeb_HowToUse_WebContainerApp,Web application implementation>>,
