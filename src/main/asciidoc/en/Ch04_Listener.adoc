...
For example set in ``ExecutionContext``, refer <<Ch06_ExceptionHandling.adoc#Ch06_ExceptionHandling_HowToUse_ExceptionHandling_Job, Exception handling of job units>>.
